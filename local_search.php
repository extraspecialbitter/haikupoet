...
$search_query =    "SELECT haiku_text, date_written FROM archive_1999 WHERE haiku_text LIKE '%$string%' UNION
                    ...
                    SELECT haiku_text, date_written FROM archive_2013 WHERE haiku_text LIKE '%$string%' UNION
                    SELECT haiku_text, date_written FROM archive_2014 WHERE haiku_text LIKE '%$string%'";
